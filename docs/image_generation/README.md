...
compilation](wifiprobe-docs/docs/image_generation/driver_compilation/README.md) for how to do that.
...
you used/are going to use the server setup script ([Website Setup](wifiprobe-docs/docs/website/setup/README.md)), this
...
- WiFi dongle shutdown script (see [The WiFi dongle shutdown script](wifiprobe-docs/docs/image_generation/shutdown_script/README.md)
